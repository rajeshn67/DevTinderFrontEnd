...
function Footer() {
  return (
    <footer className="footer bg-base-300 text-gray-300 p-4 flex flex-col md:flex-row justify-between items-center shadow-md fixed bottom-0 ">
      ...
      <nav className="flex items-center gap-6 mt-3 md:mt-0">
        ...
        {/* Instagram */}
        <a
          href="https://www.instagram.com/rajeshhhh._.20"
          target="_blank"
          rel="noopener noreferrer"
